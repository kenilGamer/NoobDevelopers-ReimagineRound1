...
function Page2setup() {
  ...
  return isMobile == false ? (
    ...
    <Swiper 
        ...
        modules={[Pagination]}
        className="mySwiper" className="w-[100vw] relative flex gap-[2vw] p-1  h-[100vh] min-h-[100vh] text-white bg-black  ">
    ...
    <div className="absolute top-[22.5vw] left-[15vw]"> 
      ...
      <div className="absolute  boxs top-[6vw] w-full h-full left-[5vw] text-3 z-30 flex flex-col gap-2 ">
          <h1 className="text-xs font-thin heading">Chipset</h1>
          <p className="text-[3vw] np  leading-2">Snapdragon 778G+ accelerated by 5G</p>
        </div>
      </div>
      </div>
     ...
     <div className="absolute top-[40.5vw] right-[5vw]"> 
      ...
      <Box w="40vw"  type="type_4"/>
            <div className="absolute  boxs top-[6vw] w-full h-full  left-[7vw] text-3 z-30 flex flex-col gap-2 ">
          <h1 className="text-xs font-thin heading">Chipset</h1>
          <p className="text-[3vw] np  leading-2">Snapdragon 778G+ accelerated by 5G</p>
        </div>
