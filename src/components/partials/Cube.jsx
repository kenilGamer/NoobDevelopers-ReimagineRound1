        ...
        <div className={`shape cuboid-1 cub-1 box state-${state}`} data-state={state}
          ...
          <div className="face tp">
            <div className="photon-shader-tp" style={{ backgroundColor: '#afafaf' }}>
              {video == 0 ? <img src={img6} alt="" /> :  <video className='-rotate-90 mt-[70%] -ml-1 scale-[2] w-full  object-cover rounded-xl' muted autoPlay loop src='/Untitled video - Made with Clipchamp.mp4' type="video/mp4" >
              </video>}
            </div>
          </div>
