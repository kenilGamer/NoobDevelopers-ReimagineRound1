...
function Slider(on) {
  ...
  return (
    <div
      className={`sd_ backdrop-blur-[10px] w-[100vw] h-[100vh]  fixed z-30 decoration-[2s]`}
      style={{
        top: on.on ? "0" : "-120vh",
    ...
    >
      <div
        className="h-[15vw] absolute top-[1vw] "
        style={{
          right: on.on ? "2vw" : "-14vw",
      ...
      >
        <div className=" relative h-full  w-[10vw]">
          ...
          />
          <img
            onClick={() => on.sendDataToParent(false)}
            src="cross.svg"
